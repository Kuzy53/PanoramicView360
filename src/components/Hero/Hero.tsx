  ...
  <section className={s.hero_wrapper} id="Welcome">
    <div className={s.content}>
      <div className={s.content_description}>
        ...
        <p className={s.subtitle}>Покажите ваше пространство так, как его увидит только ваш клиент! Панорамные 360° экскурсии – инновационный инструмент для демонстрации объектов недвижимости и коммерческих помещений.</p>
        <div className={s.content_button}>
          ...
          <button className={s.app} type="button">Заказать сайт</button>
