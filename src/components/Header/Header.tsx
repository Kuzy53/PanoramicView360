    ...
    <header className={s.header}>
      <div className={s.wrapper}>
        <div className={s.logo}>
          <Link to="/home"><img alt="Logo" className={s.logoBig} src={logo} /></Link>
          <Link to="/home"><img alt="Logo" className={s.logoMini} src={logoMini} /></Link>
          <h1>PanoramicView</h1>
        </div>
        ...
        <div className={s.navigation_mobile}>
          ...
          <nav className={isOpenDropdown ? `${s.mobile_dropdown} ${s.active_dropdown}` : `${s.mobileHidden}`}>
            <ul>
              <li>
                <Link to="/home" onClick={() => openDropdown()}>Home</Link>
              </li>
              <li>
                <Link to="/about" onClick={() => openDropdown()}>About us</Link>
              </li>
              <li>
                <button className={s.dropdown_btn} type="button" onClick={() => openSubDropdown()}>
                  <span>Partnership</span>
                  <img alt="dropdown button" className={isOpenSubDropdown ? s.chevronDown : ''} src={chevronDown} />
                </button>
                {
                  isOpenSubDropdown && (
                    <div className={s.dropdown_wrapper}>
                      <div className={s.dropdown}>
                        <Link className={s.dropdown_link} to="/place-station" onClick={() => openDropdown()}>
                          <svg
                            fill="none"
                            height="24"
                            viewBox="0 0 24 24"
                          ...
                          <div>
                            ...
                            <p className={s.dropdown_description}>The latest industry news, updates and info.</p>
                          </div>
                        </Link>
                        <Link className={s.dropdown_link} to="/partnership" onClick={() => openDropdown()}>
                          <svg
                            fill="none"
                            height="24"
                            viewBox="0 0 24 24"
        ...
        <div className={s.actions}>
          <a className={s.actions_contact} href="#ContactUs" type="button"><span>Contact Us</span></a>
          <button className={s.actions_app} type="button"><span>Get Start</span></button>
        </div>
      </div>
    </header>
  );
