...
const HEADERS = ['Зарегистрируйтесь и настройте свой профиль',
  'Создайте свой 360° тур',
  'Поделитесь туром с миром'];

const BODY = ['Создание первого шага — это всего несколько кликов. Зарегистрируйтесь на платформе, создайте свой аккаунт и настройте профиль.',
