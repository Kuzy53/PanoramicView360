...
const AboutUs = () => {
  ...
  const FAQSubtitle =
    "At ChargeMate, we believe charging isn't just a routine, it's an art. Dive into our world where technology dances with convenience, creating a masterpiece every time you plug in.";
          ...
          <div className='content-21'>
            <div className='heading-and-supporting-text-9'>
              ...
              <div className='b1 white'>
                ...
                believe in charging moments, memories, and milestones. Our mission? To ensure
                you&#x27;re always connected to what matters most.
              </div>
            </div>
            <div className='actions-5'>
              ...
              <a className='button-17' rel='noreferrer' target='_blank'>
              ...
              <div className='heading-and-supporting-text-25'>
                <div className='frame-512614'>
                  ...
                  <div className='b1 white'>
                    ...
                    Discover why we stand out in the crowded world of mobile charging, and how our
                    unwavering commitment to excellence has shaped our story from day one.
                  </div>
                </div>
                  ...
                  <div className='content-63'>
                    <div className='text-and-supporting-text-17'>
                      ...
                      <div className='b2'>
                        ...
                        your back, ensuring you&#x27;re always in the loop, literally and
                        figuratively!
                      </div>
                    </div>
                  </div>
          ...
          <div className='content-26'>
            <div className='badge-h2-description'>
              ...
              <div className='b1 white centered'>
                At ChargeMate, we believe charging isn&#x27;t just a routine, it&#x27;s an art. Dive
                into our world where technology dances with convenience, creating a masterpiece
